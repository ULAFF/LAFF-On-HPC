		        ...
		        double *BlockA, double *PanelB, double *C, int ldC )
{
  ...
  for ( int p=0; p<k; p+=4 ){
    ...
    /* load beta( p, 0:7 ) */
    beta_p_0123 = _mm256_loadu_pd( PanelB+8 );
    beta_p_4567 = _mm256_loadu_pd( PanelB+12 );

    /* load alpha( 0, p ); update gamma( 0, 0:7 ) */
    alpha_i0_p = _mm256_broadcast_sd( BlockA+6 );
    alpha_i1_p = _mm256_broadcast_sd( BlockA+7 );
    gamma_0_0123 = _mm256_fmadd_pd( alpha_i0_p, beta_p_0123, gamma_0_0123 );
    gamma_0_4567 = _mm256_fmadd_pd( alpha_i0_p, beta_p_4567, gamma_0_4567 );
    ...
    /* load alpha( 2, p ); update gamma( 2, 0:7 ) */
    alpha_i0_p = _mm256_broadcast_sd( BlockA+8 );
    alpha_i1_p = _mm256_broadcast_sd( BlockA+9 );
    gamma_2_0123 = _mm256_fmadd_pd( alpha_i0_p, beta_p_0123, gamma_2_0123 );
    gamma_2_4567 = _mm256_fmadd_pd( alpha_i0_p, beta_p_4567, gamma_2_4567 );
    ...
    /* load alpha( 4, p ); update gamma( 4, 0:7 ) */
    alpha_i0_p = _mm256_broadcast_sd( BlockA+10 );
    alpha_i1_p = _mm256_broadcast_sd( BlockA+11 );
    gamma_4_0123 = _mm256_fmadd_pd( alpha_i0_p, beta_p_0123, gamma_4_0123 );
    gamma_4_4567 = _mm256_fmadd_pd( alpha_i0_p, beta_p_4567, gamma_4_4567 );
    ...
    /* load beta( p, 0:7 ) */
    beta_p_0123 = _mm256_loadu_pd( PanelB+16 );
    beta_p_4567 = _mm256_loadu_pd( PanelB+20 );

    /* load alpha( 0, p ); update gamma( 0, 0:7 ) */
    alpha_i0_p = _mm256_broadcast_sd( BlockA+12 );
    alpha_i1_p = _mm256_broadcast_sd( BlockA+13 );
    gamma_0_0123 = _mm256_fmadd_pd( alpha_i0_p, beta_p_0123, gamma_0_0123 );
    gamma_0_4567 = _mm256_fmadd_pd( alpha_i0_p, beta_p_4567, gamma_0_4567 );
    ...
    /* load alpha( 2, p ); update gamma( 2, 0:7 ) */
    alpha_i0_p = _mm256_broadcast_sd( BlockA+14 );
    alpha_i1_p = _mm256_broadcast_sd( BlockA+15 );
    gamma_2_0123 = _mm256_fmadd_pd( alpha_i0_p, beta_p_0123, gamma_2_0123 );
    gamma_2_4567 = _mm256_fmadd_pd( alpha_i0_p, beta_p_4567, gamma_2_4567 );
    ...
    /* load alpha( 4, p ); update gamma( 4, 0:7 ) */
    alpha_i0_p = _mm256_broadcast_sd( BlockA+16 );
    alpha_i1_p = _mm256_broadcast_sd( BlockA+17 );
    gamma_4_0123 = _mm256_fmadd_pd( alpha_i0_p, beta_p_0123, gamma_4_0123 );
    gamma_4_4567 = _mm256_fmadd_pd( alpha_i0_p, beta_p_4567, gamma_4_4567 );
    ...
    /* load beta( p, 0:7 ) */
    beta_p_0123 = _mm256_loadu_pd( PanelB+24 );
    beta_p_4567 = _mm256_loadu_pd( PanelB+28 );

    /* load alpha( 0, p ); update gamma( 0, 0:7 ) */
    alpha_i0_p = _mm256_broadcast_sd( BlockA+18 );
    alpha_i1_p = _mm256_broadcast_sd( BlockA+19 );
    gamma_0_0123 = _mm256_fmadd_pd( alpha_i0_p, beta_p_0123, gamma_0_0123 );
    gamma_0_4567 = _mm256_fmadd_pd( alpha_i0_p, beta_p_4567, gamma_0_4567 );
    ...
    /* load alpha( 2, p ); update gamma( 2, 0:7 ) */
    alpha_i0_p = _mm256_broadcast_sd( BlockA+20 );
    alpha_i1_p = _mm256_broadcast_sd( BlockA+21 );
    gamma_2_0123 = _mm256_fmadd_pd( alpha_i0_p, beta_p_0123, gamma_2_0123 );
    gamma_2_4567 = _mm256_fmadd_pd( alpha_i0_p, beta_p_4567, gamma_2_4567 );
    ...
    /* load alpha( 4, p ); update gamma( 4, 0:7 ) */
    alpha_i0_p = _mm256_broadcast_sd( BlockA+22 );
    alpha_i1_p = _mm256_broadcast_sd( BlockA+23 );
    gamma_4_0123 = _mm256_fmadd_pd( alpha_i0_p, beta_p_0123, gamma_4_0123 );
    gamma_4_4567 = _mm256_fmadd_pd( alpha_i0_p, beta_p_4567, gamma_4_4567 );
