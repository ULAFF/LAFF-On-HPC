		        ...
		        double *BlockA, double *PanelB, double *C, int ldC )
{
  ...
  for ( int p=0; p<k; p++ ){
    ...
    alpha_i_p = _mm256_broadcast_sd( BlockA );
    gamma_0_0123 = _mm256_fmadd_pd( alpha_i_p, beta_p_0123, gamma_0_0123 );
    gamma_0_4567 = _mm256_fmadd_pd( alpha_i_p, beta_p_4567, gamma_0_4567 );

    /* load alpha( 1, p ); update gamma( 1, 0:7 ) */
    alpha_i_p = _mm256_broadcast_sd( BlockA+1 );
    gamma_1_0123 = _mm256_fmadd_pd( alpha_i_p, beta_p_0123, gamma_1_0123 );
    gamma_1_4567 = _mm256_fmadd_pd( alpha_i_p, beta_p_4567, gamma_1_4567 );

    /* load alpha( 2, p ); update gamma( 2, 0:7 ) */
    alpha_i_p = _mm256_broadcast_sd( BlockA+2 );
    gamma_2_0123 = _mm256_fmadd_pd( alpha_i_p, beta_p_0123, gamma_2_0123 );
    gamma_2_4567 = _mm256_fmadd_pd( alpha_i_p, beta_p_4567, gamma_2_4567 );

    /* load alpha( 3, p ); update gamma( 3, 0:7 ) */
    alpha_i_p = _mm256_broadcast_sd( BlockA+3 );
    gamma_3_0123 = _mm256_fmadd_pd( alpha_i_p, beta_p_0123, gamma_3_0123 );
    gamma_3_4567 = _mm256_fmadd_pd( alpha_i_p, beta_p_4567, gamma_3_4567 );

    /* load alpha( 4, p ); update gamma( 4, 0:7 ) */
    alpha_i_p = _mm256_broadcast_sd( BlockA+4 );
    gamma_4_0123 = _mm256_fmadd_pd( alpha_i_p, beta_p_0123, gamma_4_0123 );
    gamma_4_4567 = _mm256_fmadd_pd( alpha_i_p, beta_p_4567, gamma_4_4567 );

    /* load alpha( 5, p ); update gamma( 5, 0:7 ) */
    alpha_i_p = _mm256_broadcast_sd( BlockA+5 );
    gamma_5_0123 = _mm256_fmadd_pd( alpha_i_p, beta_p_0123, gamma_5_0123 );
    gamma_5_4567 = _mm256_fmadd_pd( alpha_i_p, beta_p_4567, gamma_5_4567 );
