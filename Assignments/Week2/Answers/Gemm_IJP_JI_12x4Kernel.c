...
void Gemm_IJP_JI_12x4Kernel( int, int, int, double *, int, double *, int,
		            double *, int );
		  ...
		  double *B, int ldB, double *C, int ldC )
{
  ...
  Gemm_IJP_JI_12x4Kernel( m, n, k, A, ldA, B, ldB, C, ldC );
}

void Gemm_IJP_JI_12x4Kernel( int m, int n, int k, double *A, int ldA,
			    double *B, int ldB, double *C, int ldC )
{
  int ib, jb, pb;
